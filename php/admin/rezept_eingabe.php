...
<form method="post" action="rezept_controller.php" >
			<table class="ausgabetab">
				<tr>
					<td>ID:</td><td>
					<input name="idrecipe"  type="text" value="<?php echo $id; ?>">
					</td>
				</tr>
				<tr>
					<td>Titel:</td><td>
				...
				<tr>
					<td>Ersteller:</td><td>
					<input name="creator" type="text" value="<?php echo $creator; ?>">
					</input></td>
				</tr>
				<tr>
					<td>Rezepttext:</td><td>					<textarea class="ckeditor" name="recipetext"><?php echo $recipeText ?></textarea></td>
				</tr>
				<tr>
					<td>
					<input type="submit" />
