...
<script type="text/javascript" src="../js/jquery-1.9.0.js"></script>
    <script type="text/javascript">
        ...
        function descopen(openobj) {            
            ...
            if(openobj == aktopen) { aktopen = null; } else { aktopen = openobj; }
        }   
    </script>
    <script type="text/javascript">
        $(function() {
...
<div id="homepage">
        ...
        <div id="home">
          <div id="menue">
            ...
            <h4><a href="../weltladen_sortiment.html">&#9658 Sortiment
              </a></h4>
              <h4><a href="../weltladen_rezepte.html">&#9658 Rezepte</a></h4>
              <p>&nbsp;</p>
              <h4>
                <h4><a href="../index.html">&#9658 Home</a></h4>
...
<hr />
              ...
              <h2>Alle, mit * 
                gekennzeichneten Lebensmittel erhalten Sie im Weltladen.<br />
                Guten Appetit!</h2>
